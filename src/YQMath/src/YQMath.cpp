#pragma once
#include "../include/YQMath.h"

namespace YQ
{

	template class YQMath_EXPORT Vec3<float>;
	template class YQMath_EXPORT Vec2<float>;
	template class YQMath_EXPORT Matrix<float, 4, 4>;
	template class YQMath_EXPORT Matrix<float, 3, 3>;
